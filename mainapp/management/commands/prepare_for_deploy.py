...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Крок 1: Видалення російських дублікатів
        ...
        # Крок 2: Перевірка та виправлення орфографії
        if not options['skip_spelling']:
        ...
        # Крок 3: Підготовка медіа файлів
        ...
        self.stdout.write(
            self.style.SUCCESS(
                ...
                f"🔗 Файл build.sh оновлено для автоматичної перевірки орфографії"
            )
        ) 